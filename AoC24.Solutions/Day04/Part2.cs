        ...
        var results = characterGrid
            ...
            .Where((a) =>
                a.Satellites.Count((sat) => sat.Character == 'M') == 2
                    ...
                    // Make sure the Ms and/or the Ss are not on opposing corners (SAS/MAM combo)
                    // Opposing corners cancel each other out when x and y are summed (e.g. (5, 3) and (3, 5) around (4, 4)),
